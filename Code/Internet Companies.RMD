...
for(i in 1:length(companyList)){
  if(companyList[i] %in% Top_246$company){
    internetComps=rbind(subset(Top_246, company==companyList[i]),internetComps)
  }
  else {
...
x=InternetComps(Top_246,companyList)
pnts=which(x$Sector=="Internet Companies")


plot(Top_246$year,Top_246$contribution,col= "red",main=" Annual Contribution Per Year ",ylim=c(-.02,.07),xlab="Years", ylab="Contribution")
points(Top_246$year[pnts], Top_246$contribution[pnts], col = "blue")
